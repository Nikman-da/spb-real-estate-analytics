...
├── README.md  
├── /sql  
│ └── real_estate_queries.sql # все SQL-запросы для обеих задач  
├── /dashboard  
│ ├── /images  
│ │ ├── overview.png # общий вид дашборда  
│ │ ├── filters.png # фильтры и детализация  
│ │ └── top5_days.png # топ-5 городов по скорости продажи  
│ └── links.txt # ссылка на опубликованный дашборд  
└── /docs  
└── data_dictionary.md # описание полей таблиц  

## 🗃 SQL‑запросы

Все запросы для решения ad‑hoc задач (время активности объявлений и сезонность) собраны в одном файле:  
👉 **[`sql/real_estate_queries.sql`](./sql/real_estate_queries.sql)**
